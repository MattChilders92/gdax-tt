...
export declare function ConsoleLoggerFactory(options?: winston.transports.ConsoleTransportOptions): Logger;
 ...
 */
export declare function SanitizedLoggerFactory(sensitiveKeys: string[], options?: winston.transports.ConsoleTransportOptions): Logger;
