...
export declare class BookBuilder extends EventEmitter implements Orderbook {
     ...
     */
    ordersForValue(side: Side, limit?: number, value?: BigJS, useQuote?: boolean, start?: StartPoint): CumulativePriceLevel[];
    getGroupedOrders(side: Side, grouping?: number, limit?: number, value?: BigJS): CumulativePriceLevel[];
    getNodesAround(side: Side, limit?: number, grouping?: number): AggregatedLevel[];
